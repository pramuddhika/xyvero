      ...
      <div className="about-hero-card">
        <div className="about-hero-content">
          ...
          <div className="about-hero-text">
            ...
            <p className="about-tagline">
              A personal finance application built to help you track expenses, manage accounts, and monitor your financial health with complete privacy and zero complexity.
            </p>
          </div>
        </div>
        ...
        <div className="about-features-grid">
          ...
          <div className="about-feature-item">
            ...
            <div className="about-feature-copy">
              <h4>Fast & Fluid</h4>
              <p>Designed for daily speed, seamless navigation, and instant access to your records.</p>
            </div>
          </div>
          ...
          <div className="about-feature-item">
            ...
            <div className="about-feature-copy">
              ...
              <p>Switch between dark and light modes, customize currencies, and match your preferences.</p>
            </div>
          </div>
        </div>
        ...
        <div className="about-link-footer">
          ...
          <span className="about-copyright">© {new Date().getFullYear()} Xyvero. All rights reserved.</span>
        </div>
      </div>
    </section>
  )
