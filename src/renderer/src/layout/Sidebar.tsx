...
const Icons: Record<string, JSX.Element> = {
  ...
  Categories: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M21 12l-9 9a2 2 0 0 1-2.8 0L3 14a2 2 0 0 1 0-2.8L12 3"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
